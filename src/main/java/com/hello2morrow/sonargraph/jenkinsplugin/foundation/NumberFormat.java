...
public class NumberFormat
{
    public static Number parse(String number)
    {
        if (number.length() > 0)
        {
             ...
             * decimal separator.
             */
            DecimalFormatSymbols symbols = StringUtility.FLOAT_FORMAT.getDecimalFormatSymbols();
            ...
            Number result = StringUtility.FLOAT_FORMAT.parse(number, new ParsePosition(0));
